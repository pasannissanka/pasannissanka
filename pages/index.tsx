...
const Home: NextPage = () => {
  return (
    <div className="p-0 w-full">
      ...
      <main className="min-h-screen-custom sm:px-16 px-4 py-0 flex-1 flex flex-col justify-center items-center">
        <div className="sm:w-3/4 w-full p-4 h-full flex sm:flex-row flex-col gap-5 items-center">
          ...
          <div className="sm:w-3/4 w-full p-2 text-center flex flex-col items-center">
            <span className="text-2xl text-gray-700 font-normal leading-relaxed ">
              👋️ Hi, I`m Pasan Nissanka, A Computer Science Undergraduate at
              University of Sri Jayawardenapura, Sri Lanka. <br />I like to
              build things. 👷️💻️🏗️
            </span>
            ...
            <div className="flex justify-self-start items-center gap-4">
              <span className="flex items-center gap-1">
                ...
                <a href="tel:+940770550016">Phone</a>
              </span>
              <span className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="mailto:pasankanishkanissanka@gmail.com">Email</a>
              </span>
              <span className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://github.com/pasannissanka">GitHub</a>
              </span>
              <span className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://www.linkedin.com/in/pasan-nissanka">LinkedIn</a>
              </span>
              <span className="flex items-center gap-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://twitter.com/PasanNissanka">Twitter</a>
              </span>
            </div>
          </div>
        </div>
